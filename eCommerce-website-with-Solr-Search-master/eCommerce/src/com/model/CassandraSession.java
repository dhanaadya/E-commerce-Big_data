...
public class CassandraSession 
{
	...
	public Session getSession() {
		  ...
		  session= cluster.connect("onlineshopping");
		  return session;
		}

	public Product getdata(String pid){
		System.out.println("searching by hitting query in cassandra ");
		ResultSet results = getSession().execute("SELECT * FROM products where product_id= '" + pid+"'");
		Product data = new Product(null, null, null, null, null, null,null,null);
		for (Row row : results) 
		{
